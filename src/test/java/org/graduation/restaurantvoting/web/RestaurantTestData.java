...
public class RestaurantTestData {
    ...
    public static final Restaurant restaurant1 = new Restaurant(RESTAURANT1_ID, "Restarant1");
    public static final Restaurant restaurant2 = new Restaurant(RESTAURANT2_ID, "Restarant2");
    public static final Restaurant restaurant3 = new Restaurant(RESTAURANT3_ID, "Restarant3");
