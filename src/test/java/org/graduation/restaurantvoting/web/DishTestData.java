...
public class DishTestData {
    ...
    public static final Dish dish1 = new Dish(DISH1_ID, "Dish1.1", 600.00, LocalDate.now(),restaurant1);
    public static final Dish dish2 = new Dish(DISH2_ID, "Dish1.2", 200.00, LocalDate.now(),restaurant1);
    public static final Dish dish3 = new Dish(DISH3_ID, "Dish2.1", 400.00, LocalDate.now(),restaurant2);
    public static final Dish dishHistory = new Dish(DISH_HISTORY_ID, "Dish1.1", 600.00, LocalDate.of(2023, Month.AUGUST, 8),restaurant1);
    ...
    public static Dish getNew() {
        return new Dish(null, "New Dish", 1000.00, LocalDate.now(),restaurant3);
    }

    public static Dish getUpdated() {
        return new Dish(DISH1_ID, "Dish1.1 Updated", 600.00, LocalDate.now(),restaurant1);
    }
}